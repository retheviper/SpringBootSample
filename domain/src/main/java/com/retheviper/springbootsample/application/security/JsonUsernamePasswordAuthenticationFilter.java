...
public class JsonUsernamePasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final String username = obtainUsername(request) != null ? obtainUsername(request) : "";
        final String password = obtainPassword(request) != null ? obtainPassword(request) : "";
    ...
    private String getParameter(final HttpServletRequest request, final String parameter) {
        if (headerContentTypeIsJson(request)) {
            return this.jsonRequest.get(parameter);
        } else {
